  ...
  return (
    <div className="flex flex-col w-[250px] h-full  bg-white py-4 px-2 justify-between">
        ...
        <Alert
          ...
          description={
            <>
              ...
              <a href="https://github.com/thrishamareddy/AskDoc" target="__blank">
                {' '}
      ...
      <div className="mt-2 flex justify-between items-center">
        <span className="text-xs text-gray-500">Made by Thrisha Reddy</span>

        <Space>
          <Button
            href="https://github.com/thrishamareddy/AskDoc"
            target="__blank"
            icon={<GithubOutlined />}
          ></Button>
